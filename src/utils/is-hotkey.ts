// TODO(sagar): use is-hotkey npm package. using a local copy because
// bundler complained about this module and couldn't fix the issue
...
function isHotkey(hotkey: HotKey, options?: any, event?: any) {
...
function isCodeHotkey(hotkey: HotKey, event?: any) {
  return isHotkey(hotkey, event);
}

function isKeyHotkey(hotkey: HotKey, event?: any) {
